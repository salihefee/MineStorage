...
public class Maps {
    public static final Map<Byte, Material> blockLookupTable = new HashMap<>();
    public static final Map<Material, Byte> byteLookupTable = new HashMap<>();
    
    // The content of this file is almost entirely copied from BK Binary's repo.
...
*/
        blockLookupTable.put((byte) 141, Material.GILDED_BLACKSTONE);
        blockLookupTable.put((byte) 142, Material.CHISELED_POLISHED_BLACKSTONE);
        blockLookupTable.put((byte) 143, Material.POLISHED_BLACKSTONE_STAIRS);
    ...
    public static void createByteLookupTable(){
